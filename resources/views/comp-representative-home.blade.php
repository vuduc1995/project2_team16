...
<head>
  ...
  <meta charset= "utf-8">
    <title>Company Representative Home</title>

    <link rel ="stylesheet" type="text/css" href ="{{ URL::asset('css/font-awesome.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('data/comp.representative-home/css/styles.css') }}">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown" id="formcv">
          ...
          <ul class="dropdown-menu">
            <li><a href="/comp-representative/Registration">Registration</a></li>
          </ul>
        </li>
